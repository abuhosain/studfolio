...
const Students = () => {
  ...
  const students = [
    ...
    { id: 45, name: "Zihadujjaman", roll: "616372" },
    { id: 46, name: "K.M. Zakaria Habib", roll: "616373" },
  ].map((student) => ({
    ...student,
    avatar: student.name
      .split(" ")
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px" }}>
        <Space direction="vertical" size="large" style={{ width: "100%" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            >
              Meet the talented Computer Science & Technology students from
              Bogura Polytechnic Institute, Session 2223
            </Paragraph>
          </div>
