...
const NafisPortfolio = () => {
    return (
        <div style={styles.page}>
            <div style={styles.hero}>
                <div style={styles.heroText}>
                    <p style={styles.badge}>Front-End & MERN Enthusiast</p>
                    <h1 style={styles.name}>Nafis Muhtasim</h1>
                    <p style={styles.meta}>Roll: 715494 · Reg: 1502248921</p>
                    <p style={styles.bio}>
            ...
            <section style={styles.section}>
                <h2 style={styles.sectionTitle}>About Nafis</h2>
            ...
            <section id="contact" style={styles.section}>
                ...
                <div style={styles.contactPanel}>
                    <div>
                        ...
                        <p style={styles.contactValue}>nafis@email.com</p>
                    </div>
                    <div>
                        <p style={styles.contactLabel}>Portfolio</p>
                        <p style={styles.contactValue}>nafis-portfolio.dev</p>
                    </div>
                    <div>
