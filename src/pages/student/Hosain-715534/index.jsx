    ...
    <div style={styles.container}>
      ...
      <div style={styles.mainCard}>
        ...
        <div style={styles.header}>
          ...
          <h1 style={styles.name}>Md. Abu Hosain</h1>
          <p style={styles.rollNumber}>Roll: 715534 | Computer Science & Technology (CST)</p>
        ...
        <div style={styles.bioSection}>
          <p style={styles.bio}>
            Passionate Computer Science student with a strong interest in web development,
            software engineering, and emerging technologies. Always eager to learn new skills
            and contribute to innovative projects that make a difference in the world.
          </p>

          {/* Contact Links */}
          <div style={styles.contactLinks}>
            <a href="mailto:abuhosainmin@gmail.com" style={styles.contactButton}>
              📧 Email
            </a>
            <a href="https://github.com/abuhosain" target="_blank" rel="noopener noreferrer" style={styles.contactButton}>
              💻 GitHub
            </a>
            <a href="https://linkedin.com/in/abuhosain25" target="_blank" rel="noopener noreferrer" style={styles.contactButton}>
              💼 LinkedIn
            </a>
            <a href="https://abuhosain.com" target="_blank" rel="noopener noreferrer" style={styles.contactButton}>
              🌐 Portfolio
            </a>
          </div>
        </div>
        ...
        <div style={styles.section}>
          ...
          <div style={styles.skillCategory}>
            ...
            <div style={styles.skillBar}>
              ...
              <div style={styles.skillPercentage}>90%</div>
            </div>
            <div style={styles.skillBar}>
              ...
              <div style={styles.skillPercentage}>75%</div>
            </div>
            <div style={styles.skillBar}>
              <div style={styles.skillName}>Java</div>
              <div style={styles.progressContainer}>
                <div style={{ ...styles.progressBar, width: '65%' }}></div>
              </div>
              <div style={styles.skillPercentage}>65%</div>
            </div>
            <div style={styles.skillBar}>
              ...
              <div style={styles.skillPercentage}>60%</div>
            </div>
          </div>
          ...
          <div style={styles.skillCategory}>
            ...
            <div style={styles.skillBar}>
              <div style={styles.skillName}>MySQL</div>
              <div style={styles.progressContainer}>
                <div style={{ ...styles.progressBar, width: '70%' }}></div>
              </div>
              <div style={styles.skillPercentage}>70%</div>
            </div>
            <div style={styles.skillBar}>
